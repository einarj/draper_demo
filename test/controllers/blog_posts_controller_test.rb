...
class BlogPostsControllerTest < ActionController::TestCase
  ...
  test "should create blog_post" do
    assert_difference('BlogPost.count') do
      post :create, blog_post: { author: @blog_post.author, content: @blog_post.content, title: @blog_post.title }
    end
  ...
  test "should update blog_post" do
    patch :update, id: @blog_post, blog_post: { author: @blog_post.author, content: @blog_post.content, title: @blog_post.title }
    assert_redirected_to blog_post_path(assigns(:blog_post))
  end
